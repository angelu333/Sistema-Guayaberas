...
// Puede ser llamada desde cualquier otro API route o server action.
// ================================================================
...
export async function sendPushToTenant(
  ...
  // Obtener todas las suscripciones activas del tenant
  ...
  await Promise.allSettled(
    subs.map(async (sub) => {
      try {
        ...
        // Códigos 410 (Gone) y 404 (Not Found) significan suscripción inválida
